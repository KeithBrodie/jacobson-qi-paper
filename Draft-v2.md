...
$$T_U = \frac{\hbar a}{2\pi c k_B} \tag{2}$$
...
$$\frac{dA}{d\lambda} = -R_{ab} \, k^a k^b \, A \tag{6}$$

where λ is the affine parameter along the generators and $R_{ab}$ is the Ricci tensor. The entropy change is therefore:

$$dS = \frac{k_B}{4\ell_P^2} \, dA = -\frac{k_B}{4\ell_P^2} \, R_{ab} \, k^a k^b \, A \, d\lambda \tag{7}$$

### D. The Einstein Equations Emerge

Substituting Eqs. (2), (5), and (7) into the Clausius relation (4):

$$T_{ab} \, k^a \, d\Sigma^b = \frac{\hbar a}{2\pi c k_B} \cdot \left( -\frac{k_B}{4\ell_P^2} \right) R_{ab} \, k^a k^b \, A \, d\lambda \tag{8}$$
...
$$R_{ab} - \frac{1}{2} R \, g_{ab} + \Lambda \, g_{ab} = \frac{8\pi G}{c^4} \, T_{ab} \tag{9}$$
...
$$R_H = \frac{c}{H_0} \approx 1.3 \times 10^{26} \text{ m} \tag{10}$$

provides a physical outer boundary. Modes with wavelengths exceeding the Hubble diameter

$$\Theta = 2R_H = \frac{2c}{H_0} \approx 2.6 \times 10^{26} \text{ m} \tag{11}$$
...
$$a_0 = cH_0 \approx 6.9 \times 10^{-10} \text{ m/s}^2 \tag{12}$$
...
$$\epsilon(a) = \frac{\lambda_R}{\Theta} = \frac{2c^2}{a\Theta} = \frac{cH_0}{a} = \frac{a_0}{a} \tag{13}$$
...
$$S'(a) = \frac{k_B A}{4\ell_P^2} \cdot \left[1 - \epsilon^2\right] = \frac{k_B A}{4\ell_P^2} \cdot \left[1 - \left(\frac{2c^2}{a\Theta}\right)^2\right] \tag{14}$$
...
$$\delta Q = T_U \, dS' \tag{15}$$

Expanding:

$$\delta Q = \frac{\hbar a}{2\pi c k_B} \cdot \frac{k_B}{4\ell_P^2} \cdot \left[1 - \left(\frac{a_0}{a}\right)^2\right] \cdot dA \tag{16}$$
...
$$F = m_g \cdot a \cdot f(a) = m_g \cdot a \cdot \left[1 - \left(\frac{a_0}{a}\right)^2\right] \tag{17}$$

We can equivalently express this as a modified inertial mass:

$$\boxed{m_i(a) = m_g \left[1 - \left(\frac{a_0}{a}\right)^2\right]} \tag{18}$$
...
$$\left(\frac{a_0}{a}\right)^2 \ll 1 \implies m_i \to m_g \tag{19}$$
...
$$\left(\frac{a_0}{a}\right)^2 \approx \left(\frac{7 \times 10^{-10}}{6 \times 10^{-3}}\right)^2 \sim 10^{-14} \tag{20}$$
...
$$\frac{m_i v^2}{r} = \frac{G M m_g}{r^2} \tag{22}$$
...
$$v^4 = GMa_0 = GMcH_0 \implies v = (GMcH_0)^{1/4} \tag{23}$$
